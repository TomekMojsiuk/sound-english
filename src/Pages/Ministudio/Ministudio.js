    ...
    return (
      <div id='ministudio' className='content__wrapper'>
        ...
        <div className='main__content'>
          ...
          <ul>
            <li>
              <span className='initial'>S</span>tudyjną rejestrację wokalistów,
              instrumentalistów, małych zespołów wokalnych bądź wokalno –
              instrumentalnych
            </li>
            <li>
              <span className='initial'>P</span>rodukcję reklam dźwiękowych, np.
              na potrzeby radia
            </li>
            <li>
            ...
            <li>
              <span className='initial'>N</span>agrania lektorskie w językach
              angielskim i polskim
            </li>
            <li>
              <span className='initial'>S</span>tworzenie i rejestrację muzyki
              do dowolnych celów np. relaksacyjnej bądź ilustracyjnej
          ...
          <p>
            <span className='initial'>S</span>tudio dysponuje własnym,
            profesjonalnym sprzętem muzycznym i studyjnym oraz mnóstwem
            kreatywnych pomysłów właściciela
          </p>
        </div>
      </div>
    );
