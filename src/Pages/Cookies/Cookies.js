   ...
   <div id='cookies' className='content__wrapper'>
    ...
    <div className='main__content'>
     ...
     <ul>
      ...
      <li>
       <span>Serwis zewnętrzny</span> - serwis internetowe partnerów,
       usługodawców lub usługobiorców Administratora{" "}
      </li>
      <li>
       <span>Administrator</span> - firma CENTRUM JĘZYKOWO-MUZYCZNE "SOUND
       ENGLISH" BARTŁOMIEJ PIWOWARCZYK, prowadząca działalność pod adresem:
      ...
      <li>
       <span>Użytkownik</span> - osba fizyczna, dla której Administrator
       świadczy usługi drogą elektroniczna za pośrednictwem Serwisu.
      </li>
      <li>
       <span>Urządzenie</span> - elektroniczne urządzenie wraz z
       oprogramowaniem, za pośrednictwem, którego Użytkownik uzyskuje dostęp do
       Serwisu
      </li>
      <li>
       <span>Cookies (ciasteczka)</span> - dane tekstowe gromadzone w formie
     ...
     <ul>
      <li>
       <span>Cookies wewnętrzne</span> - pliki zamieszczane i odczytywane z
       Urządzenia Użytkownika przes system teleinformatyczny Serwisu
      </li>
      <li>
       <span>Cookies zewnętrzne</span> - pliki zamieszczane i odczytywane z
       Urządzenia Użytkownika przez systemy teleinformatyczne Serwisów
       zewnętrznych
      </li>
      <li>
       <span>Cookies sesyjne</span> - pliki zamieszczane i odczytywane z
       Urządzenia Użytkownika przez Serwis lub Serwisy zewnętrzne podczas jednej
       sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z
       Urządzenia Użytkownika.
      </li>
      <li>
       <span>Cookies trwałe</span> - pliki zamieszczane i odczytywane z
       Urządzenia Użytkownika przez Serwis lub Serwisy zewnętrzne do momentu ich
     ...
     <ul>
      <li>
       <span>Mechanizmy składowania i odczytu</span> - Mechanizmy składowania i
       ...
       innych robaków jest praktynie niemożliwe.
      </li>
      <li>
       <span>Cookie wewnętrzne</span> - zastosowane przez Administratora Cookie
       wewnętrzne są bezpieczne dla Urządzeń Użytkowników
      </li>
      <li>
       <span>Cookie zewnętrzne</span> - za bezpieczeństwo plików Cookie
     ...
     <ul>
      <li>
       <span>Serwowanie usług multimedialnych</span> - Administrator oraz
       Serwisy zewnętrzne wykorzystuje pliki Cookie do serwowania Użytkownikom
       usług multimedialnych.
      </li>
      <li>
       <span>Usługi społecznościowe</span> - Administrator oraz Serwisy
       zewnętrzne wykorzystują pliki Cookie do wsparcia usług społecznościowych.
      </li>
      <li>
       <span>Formularze</span> - Administrator wykorzystuje pliki Cookie do
       celów wsparcia komunikacji poprzez formularz kontaktowy w Serwisie.
      </li>
     </ul>
     ...
     <h2>
      <span>§6</span> Możliwości określenia warunków przechowywania i
      uzyskiwania dostępu na urządzeniach użytkownika przez Serwis i serwisy
      zewnętrzne
     </h2>
     <div className='underline' />
     ...
     <ul>
      ...
      <li>
       Użytkownik może w dowolnym momencie usunąć wszelkie zapisane do tej pory
       pliki Cookie korzystając z narzędzi Urządzenia Użytkownika za
