  ...
  return (
   <div id='rodo' className='content__wrapper'>
    ...
    <div className='main__content'>
     ...
     <h2>
      <span>O</span>bowiązek informacyjny dotyczący ochrony Twoich danych
      osobowych
     </h2>
     ...
     <p>
      25 maja 2018 r. weszło w życie Rozporządzenie Parlamentu Europejskiego i
      Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. w sprawie ochrony osób
      fizycznych w związku z przetwarzaniem danych osobowych i w sprawie
      swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE
      (RODO), czyli nowe unijne rozporządzenie, którego celem jest
      unowocześnienie oraz ujednolicenie regulacji dotyczących ochrony danych
      osobowych obowiązujących na terenie UE.
     </p>
     <h2>
     ...
     <p>
      ...
      wykorzystywane Twoje dane osobowe, jest:
     </p>
     <p>
     ...
     <div className='underline' />
     <p>
      Masz pytania odnośnie przetwarzania Twoich danych osobowych? Zadzwoń,
      napisz na adres korespondencyjny lub mailowy, lub skorzystaj z formularza kontaktowego:
     </p>
     ...
     <ul>
      ...
      <li>
       realizacji nagrań dźwiękowych i publikowania tych nagrań w serwisach www
       (np. youtube, facebook),
      </li>
     ...
     <ul>
      <li>
       Twoje dane osobowe przetwarzane będą na podstawie art. 6 ust 1 lit. b
       RODO, tj. w sytuacji gdy przetwarzanie jest niezbędne do zawarcia i
     ...
     <p>
      Pmamiętaj, że dane osobowe podajesz nam dobrowolnie, ale czasem ich
      podanie jest konieczne do zrealizowania usługi.
     </p>
     <h2>
     ...
     <ul>
      ...
      <li>
       Wybrani kontrahenci, z którymi współpracuje Centrum jęwykowo-muzyczne
       "Sound English" (np. drukarnia - wydruk dyplomów dla kursantów).
      </li>
     </ul>
     <h2>
     ...
     <div className='underline' />
     <p>
      Twoje dane przetwarzamy przez okres trwania umowy na kurs językowy lub na
      inną świadczoną przez nas usługę.
     </p>
     ...
     <ul>
      ...
      <li>
       usunięcia danych, jeżeli nie następują przesłanki wyłączające, wynikające
       z art. 17 ust. 3 RODO,
      </li>
      <li>wniesienia sprzeciwu wobec przetwarzania danych osobowych.</li>
     </ul>
     <p>
      Z uprawnień możesz skorzystać kontaktując się z nami za pośrednictwem
      poczty tradycyjnej lub elektronicznej
      <br /> (Patrz: sekcja "<span>J</span>ak się z nami skontaktować?"
     </p>
     <p>
      Pamiętaj również, że przysługuje Ci prawo wniesienia skargi do Organu
      Nadzorczego nadzorującego ochronę danych osobowych (do 25 maja 2018 r.
      GIODO, od 25 maja 2018 r. PUODO), gdy uznasz, iż ich przetwarzanie narusza
      unijne Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia
      27 kwietnia 2016 r. w sprawie ochrony osób fizycznych w związku z
      przetwarzaniem danych osobowych i w sprawie swobodnego przepływu takich
      danych oraz uchylenia dyrektywy 95/46/WE (tzw. ogólne rozporządzenie o
      ochronie danych osobowych, w skrócie RODO).
     </p>
    </div>
   </div>
  );
