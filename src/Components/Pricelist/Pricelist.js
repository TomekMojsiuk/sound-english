  ...
  return (
    <div id='pricelist'>
      ...
      <div className='pricelist__content'>
        <div className='content__flex__wrapper'>
          <div className='pricelist__items__group '>
            ...
            <div className='pricelist__item'>
              <div className='pricelist__item__name'>Zajęcia w studio Sound English</div>
            ...
            <div className='pricelist__item'>
              <div className='pricelist__item__name'>Zajęcia z dojazdem do domu ucznia</div>
              <div className='pricelist__item__price'>
                <b>225zł</b>
              </div>
            </div>
        ...
        <div className='content__flex__wrapper'>
          <div className='pricelist__items__group'>
            ...
            <div className='pricelist__item'>
              <div className='pricelist__item__name'>Zajęcia od poniedziałku do piątku:</div>
              <div className='pricelist__item__price'>
                <b>40zł</b>
              </div>
            </div>
      ...
      <p className={'footnote'}>
        <span>P</span>referowana forma płatności to płatność gotówką bądź przelewem do 10 dnia
        miesiąca, wystawiamy faktury VAT.
      </p>
      ...
      <p className={'footnote'}>
        <span className={'asterisk'}>&#42; &#42;</span> <span>W</span> Sound English grupa to już 2
        osoby!
      </p>
    </div>
  );
